...
import 'package:onproperty/widgets/contactUsDropDown.dart';
  ...
  return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          customListTile(Icons.place, 'Address',
              'No. 123 Oron Road, Uyo, Akwa Ibom State'),
          SizedBox(
            height: 15,
          ),
          ...
          customListTile(Icons.email, 'Email Us', 'info@ibaka.com'),
          SizedBox(
            height: 15,
          ),
          customListTile(Icons.language, 'Website URL', 'www.ibakaverse.com')
        ],
      ));
}
